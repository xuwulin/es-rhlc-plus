...
public interface Geo<Children, R> extends Serializable {
    default Children geoBoundingBox(R column, GeoPoint topLeft, GeoPoint bottomRight) {
        return geoBoundingBox(true, column, topLeft, bottomRight, EsConstants.DEFAULT_BOOST);
    }

    default Children geoBoundingBox(boolean condition, R column, GeoPoint topLeft, GeoPoint bottomRight) {
        return geoBoundingBox(condition, column, topLeft, bottomRight, EsConstants.DEFAULT_BOOST);
    }
    ...
    default Children geoBoundingBox(R column, String topLeft, String bottomRight) {
        ...
        return geoBoundingBox(true, column, topLeftGeoPoint, bottomRightGeoPoint, EsConstants.DEFAULT_BOOST);
    }

    default Children geoBoundingBox(boolean condition, R column, String topLeft, String bottomRight) {
        GeoPoint topLeftGeoPoint = new GeoPoint(topLeft);
        GeoPoint bottomRightGeoPoint = new GeoPoint(bottomRight);
        return geoBoundingBox(condition, column, topLeftGeoPoint, bottomRightGeoPoint, EsConstants.DEFAULT_BOOST);
    }
    ...
    default Children notInGeoBoundingBox(R column, GeoPoint topLeft, GeoPoint bottomRight) {
        return notInGeoBoundingBox(true, column, topLeft, bottomRight, EsConstants.DEFAULT_BOOST);
    }

    default Children notInGeoBoundingBox(boolean condition, R column, GeoPoint topLeft, GeoPoint bottomRight) {
        return notInGeoBoundingBox(condition, column, topLeft, bottomRight, EsConstants.DEFAULT_BOOST);
    }
    ...
    default Children notInGeoBoundingBox(R column, String topLeft, String bottomRight) {
        GeoPoint topLeftGeoPoint = new GeoPoint(topLeft);
        GeoPoint bottomRightGeoPoint = new GeoPoint(bottomRight);
        return notInGeoBoundingBox(true, column, topLeftGeoPoint, bottomRightGeoPoint, EsConstants.DEFAULT_BOOST);
    }

    default Children notInGeoBoundingBox(boolean condition, R column, String topLeft, String bottomRight) {
        GeoPoint topLeftGeoPoint = new GeoPoint(topLeft);
        GeoPoint bottomRightGeoPoint = new GeoPoint(bottomRight);
        return notInGeoBoundingBox(condition, column, topLeftGeoPoint, bottomRightGeoPoint, EsConstants.DEFAULT_BOOST);
    }
     ...
     * @return 泛型
     */
    Children notInGeoBoundingBox(boolean condition, R column, GeoPoint topLeft, GeoPoint bottomRight, Float boost);

    default Children geoDistance(R column, Double distance, GeoPoint centralGeoPoint) {
        return geoDistance(true, column, distance, DistanceUnit.KILOMETERS, centralGeoPoint, EsConstants.DEFAULT_BOOST);
    }

    default Children geoDistance(R column, Double distance, DistanceUnit distanceUnit, GeoPoint centralGeoPoint) {
        return geoDistance(true, column, distance, distanceUnit, centralGeoPoint, EsConstants.DEFAULT_BOOST);
    }
    ...
    default Children geoDistance(R column, Double distance, DistanceUnit distanceUnit, String centralGeoPoint) {
        ...
        return geoDistance(true, column, distance, distanceUnit, geoPoint, EsConstants.DEFAULT_BOOST);
    }

    default Children geoDistance(boolean condition, R column, Double distance, DistanceUnit distanceUnit, String centralGeoPoint) {
        GeoPoint geoPoint = new GeoPoint(centralGeoPoint);
        return geoDistance(condition, column, distance, distanceUnit, geoPoint, EsConstants.DEFAULT_BOOST);
    }
    ...
    default Children notInGeoDistance(R column, Double distance, GeoPoint centralGeoPoint) {
        return notInGeoDistance(true, column, distance, DistanceUnit.KILOMETERS, centralGeoPoint, EsConstants.DEFAULT_BOOST);
    }

    default Children notInGeoDistance(R column, Double distance, DistanceUnit distanceUnit, GeoPoint centralGeoPoint) {
        return notInGeoDistance(true, column, distance, distanceUnit, centralGeoPoint, EsConstants.DEFAULT_BOOST);
    }
    ...
    default Children notInGeoDistance(R column, Double distance, DistanceUnit distanceUnit, String centralGeoPoint) {
        GeoPoint geoPoint = new GeoPoint(centralGeoPoint);
        return notInGeoDistance(true, column, distance, distanceUnit, geoPoint, EsConstants.DEFAULT_BOOST);
    }
    ...
    default Children notInGeoDistance(boolean condition, R column, Double distance, DistanceUnit distanceUnit, String centralGeoPoint) {
        GeoPoint geoPoint = new GeoPoint(centralGeoPoint);
        return notInGeoDistance(condition, column, distance, distanceUnit, geoPoint, EsConstants.DEFAULT_BOOST);
    }
     ...
     * @return 泛型
     */
    Children notInGeoDistance(boolean condition, R column, Double distance, DistanceUnit distanceUnit, GeoPoint centralGeoPoint, Float boost);

    default Children geoDistance(R column, String distance, GeoPoint centralGeoPoint) {
        return geoDistance(true, column, distance, centralGeoPoint, EsConstants.DEFAULT_BOOST);
    }

    default Children geoDistance(boolean condition, R column, String distance, GeoPoint centralGeoPoint) {
        return geoDistance(condition, column, distance, centralGeoPoint, EsConstants.DEFAULT_BOOST);
    }
    ...
    default Children geoDistance(R column, String distance, String centralGeoPoint) {
        GeoPoint geoPoint = new GeoPoint(centralGeoPoint);
        return geoDistance(true, column, distance, geoPoint, EsConstants.DEFAULT_BOOST);
    }

    default Children geoDistance(boolean condition, R column, String distance, String centralGeoPoint) {
        GeoPoint geoPoint = new GeoPoint(centralGeoPoint);
        return geoDistance(condition, column, distance, geoPoint, EsConstants.DEFAULT_BOOST);
    }
    ...
    default Children notInGeoDistance(R column, String distance, GeoPoint centralGeoPoint) {
        return notInGeoDistance(true, column, distance, centralGeoPoint, EsConstants.DEFAULT_BOOST);
    }

    default Children notInGeoDistance(boolean condition, R column, String distance, GeoPoint centralGeoPoint) {
        return notInGeoDistance(condition, column, distance, centralGeoPoint, EsConstants.DEFAULT_BOOST);
    }
    ...
    default Children notInGeoDistance(R column, String distance, String centralGeoPoint) {
        GeoPoint geoPoint = new GeoPoint(centralGeoPoint);
        return notInGeoDistance(true, column, distance, geoPoint, EsConstants.DEFAULT_BOOST);
    }

    default Children notInGeoDistance(boolean condition, R column, String distance, String centralGeoPoint) {
        GeoPoint geoPoint = new GeoPoint(centralGeoPoint);
        return notInGeoDistance(condition, column, distance, geoPoint, EsConstants.DEFAULT_BOOST);
    }
     ...
     * @return 泛型
     */
    Children notInGeoDistance(boolean condition, R column, String distance, GeoPoint centralGeoPoint, Float boost);

    default Children geoPolygon(R column, List<GeoPoint> geoPoints) {
        return geoPolygon(true, column, geoPoints, EsConstants.DEFAULT_BOOST);
    }

    default Children geoPolygon(boolean condition, R column, List<GeoPoint> geoPoints) {
        return geoPolygon(condition, column, geoPoints, EsConstants.DEFAULT_BOOST);
    }
    ...
    default Children geoPolygonStr(R column, List<String> strPoints) {
        if (CollectionUtils.isEmpty(strPoints)) {
            throw ExceptionUtils.epe("polygon point list must not be empty");
        }
    ...
    default Children notInGeoPolygon(R column, Collection<GeoPoint> geoPoints) {
        return notInGeoPolygon(true, column, geoPoints, EsConstants.DEFAULT_BOOST);
    }

    default Children notInGeoPolygon(boolean condition, R column, Collection<GeoPoint> geoPoints) {
        return notInGeoPolygon(condition, column, geoPoints, EsConstants.DEFAULT_BOOST);
    }
     ...
     * @return 泛型
     */
    Children notInGeoPolygon(boolean condition, R column, Collection<GeoPoint> geoPoints, Float boost);


    default Children geoShape(R column, String indexedShapeId) {
        return geoShape(true, column, indexedShapeId, EsConstants.DEFAULT_BOOST);
    }
    ...
    default Children geoShape(boolean condition, R column, String indexedShapeId) {
        return geoShape(condition, column, indexedShapeId, EsConstants.DEFAULT_BOOST);
    }
    ...
    default Children notInGeoShape(R column, String indexedShapeId) {
        return notInGeoShape(true, column, indexedShapeId, EsConstants.DEFAULT_BOOST);
    }
    ...
    default Children notInGeoShape(boolean condition, R column, String indexedShapeId) {
        return notInGeoShape(condition, column, indexedShapeId, EsConstants.DEFAULT_BOOST);
    }
     ...
     * @return 泛型
     */
    Children notInGeoShape(boolean condition, R column, String indexedShapeId, Float boost);


    default Children geoShape(R column, Geometry geometry) {
        return geoShape(true, column, geometry, ShapeRelation.WITHIN, EsConstants.DEFAULT_BOOST);
    }

    default Children geoShape(R column, Geometry geometry, ShapeRelation shapeRelation) {
        return geoShape(true, column, geometry, shapeRelation, EsConstants.DEFAULT_BOOST);
    }

    default Children geoShape(boolean condition, R column, Geometry geometry, ShapeRelation shapeRelation) {
        return geoShape(condition, column, geometry, shapeRelation, EsConstants.DEFAULT_BOOST);
    }
    ...
    default Children notInGeoShape(R column, Geometry geometry) {
        return notInGeoShape(true, column, geometry, ShapeRelation.WITHIN, EsConstants.DEFAULT_BOOST);
    }

    default Children notInGeoShape(R column, Geometry geometry, ShapeRelation shapeRelation) {
        return notInGeoShape(true, column, geometry, shapeRelation, EsConstants.DEFAULT_BOOST);
    }

    default Children notInGeoShape(boolean condition, R column, Geometry geometry, ShapeRelation shapeRelation) {
        return notInGeoShape(condition, column, geometry, shapeRelation, EsConstants.DEFAULT_BOOST);
    }
     ...
     * @return 泛型
     */
    Children notInGeoShape(boolean condition, R column, Geometry geometry, ShapeRelation shapeRelation, Float boost);
}
